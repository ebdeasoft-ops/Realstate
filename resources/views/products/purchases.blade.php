...
<div class="main-parent">
    <div class="breadcrumb-header justify-content-between"
        ...
        <div class="my-auto">
            <h4 class="content-title mb-0" style="color: #23395D; font-weight: bold; font-size: 18px;">
                {{ __('home.purchases') }}</h4>
        </div>
                        ...
                        <div class="row row-sm align-items-end p-3 shadow-sm mb-4"
                            ...
                            <div class="col-lg-2 mg-t-10">
                                ...
                                <select class="form-control select2" name="paymentmethod" id="paymentmethod" required>
                                    @foreach (App\Models\financial_accounts::whereIn('parent_account_number', [4,
                                    5])->get() as $section)
                                    <option value="{{ $section->id }}">
                                        {{ app()->getLocale() == 'en' ? $section->name_en : $section->name }} </option>
                                    @endforeach
                            ...
                            <div class="col-lg-2 mg-t-10">
                                ...
                                <select class="form-control select2" id="Main_branchs_id">
                                    ...
                                    @foreach (App\Models\branchs::where('id','!=',Auth()->user()->branch->id
                                    )->where('type',2 )->get()
                                    as $section)
                ...
                <div class=" justify-content-center" id="printdiv">
                    ...
                    <form action="{{ '/' . ($page = 'printProductToSupllier') }}" method="POST" role="search"
                        ...
                        <div class='col ' id="printdiv">
                            ...
                            <button style="background-color: #23395D;font-size:15px;width: 80px!important;height:35px"
