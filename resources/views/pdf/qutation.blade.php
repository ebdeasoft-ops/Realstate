...
<body>
  ...
  <center> <p  class="double"> عرض تسعيرة للعميل - Quote to the customer</p></center>
     <?php
    ...
    <center>
      <table dir="rtl" style="border:2px solid rgba(0,0,0,.3);width:100%">
        ...
        <tbody>
          ...
          <tr>
            <td style=" border: 1px solid black;" class="tx-18"> <center> {{ round($totaldiscount,2) }}</center></td>
            <td style=" border: 1px solid black;" class="tx-18" >  <center>  الخصم  DISCOUNT </center> </td>

          </tr>
          <tr>
            <td style=" border: 1px solid black;" class="tx-18">  <center> {{ round($totalpricePurchases,2)- round($totaldiscount,2) }} </center></td>
          ...
          <tr>
            ...
            <td style=" border: 1px solid black;" class="tx-18"> <center> {{  round((round($totalpricePurchases,2)- round($totaldiscount,2))* $avt->AVT,2)}} </center></td>
          ...
          <?php
          $total = round((round($totalpricePurchases,2)- round($totaldiscount,2))* $avt->AVT,2)+(round($totalpricePurchases,2)- round($totaldiscount,2)) ;
